...
//#define USB_SERIAL_DEFAULT_VALUES {'B','U','R','1','5','0','4','7','1','4','8','9'}
#define USB_SERIAL_DEFAULT_VALUES {'B','U','R','1','5','4','3','8','1','6','8','0'}
...
typedef struct _USB_SERIAL_NUMBER_DESCRIPTOR
{
    uint8_t bLength;       
    uint8_t bDscType;      
    uint16_t string[USB_SERIAL_NUMBER_LENGTH_IN_WORDS]; 
...
const USB_SERIAL_NUMBER_DESCRIPTOR sd003={
