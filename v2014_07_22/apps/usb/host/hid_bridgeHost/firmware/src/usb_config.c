...
USB_TPL usbTPL[] =
{
    //timwuu 2015.04.12 { INIT_CL_SC_P( 3ul, 1ul, 1ul ), 0, 0, {TPL_CLASS_DRV} } // (null)
    //Reference AN1141, pp.23
    //{ INIT_VID_PID( 0x04D8ul, 0x0033ul), 0, 0, {0} } // PICKIT2
    //{ INIT_VID_PID( 0x04D8ul, 0x900Aul), 0, 0, {0} } // PICKIT3
    { INIT_VID_PID( 0x04D8ul, 0x8107ul), 0, 0, {0} } // PKOB
};
